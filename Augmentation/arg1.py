...
def process_variant() -> None:
    ...
    for idx, src_video in enumerate(video_files, start=1):
        ...
        dst_video = (
            ...
            / f"{src_video.stem}_arg1{src_video.suffix}"
        )
    ...
    write_labels(OUT_ROOT / "labels.csv", source_order_map, "arg1")
    log(f"\nDone arg1. Output: {OUT_ROOT}")
